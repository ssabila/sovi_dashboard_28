...
ui <- bs4DashPage(
  ...
  bs4DashBody(
    # Custom CSS
    tags$head(
      tags$link(href = "https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap", rel = "stylesheet"),
      tags$style(HTML("
        /* Basic styling */
        body, .content-wrapper, .right-side, .main-header, .main-sidebar, .skin-blue .main-header .logo, .skin-blue .main-header .navbar {
